...
public class TestStatisticsMultipleWindowSizeScorer extends EnhancedTestCase
{
	private static final StatisticsMultipleWindowSizeScorer SCORER = new StatisticsMultipleWindowSizeScorer(
			Config.INDEX_FOLDER);
