...
public class TestRuleBasedTrueCaserImpl
{
	...
	private List<List<String>> getTokens(String textString)
	{
		Annotation document = new Annotation(textString);
