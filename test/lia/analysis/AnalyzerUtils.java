...
public class AnalyzerUtils
{
	...
	*/
	...
	//	{
	//		System.out.println("StemmedStandardAnalyzer");
	//		displayTokensWithFullDetails(new StemmedStandardAnalyzer(),
	//				"The quick brown fox....I'll email you at xyz@example.com");
	//
	//		System.out.println("\n----");
	//		System.out.println("StandardAnalyzer");
	//		displayTokensWithFullDetails(new StemmedSynonymWikipediaAnalyzer()
	//		{
	//			@Override
