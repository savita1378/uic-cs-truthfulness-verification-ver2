...
public class TestWindowScorer_PARAGRAPH extends EnhancedTestCase
{
	private static final WindowScorer SCORER = new WindowScorer(
			Config.INDEX_FOLDER, IndexBy.PARAGRAPH, Config.SEARCH_WINDOW, false);
