...
public class IndexBuilder
{
	 ...
	 */
	private static Map<String, List<String>> getUrlsByAlternativeUnit(
			Statement statement)
	{
			...
			HashSet<String> indexedUnits)
	{
		...
		Map<String, List<String>> urlsByTopicUnit = STATEMENT_ANALYZER
				.getUrlsByTopicUnit(statement);
		// get alternative units and their corresponding URLs
		Map<String, List<String>> urlsByAlternativeUnit = getUrlsByAlternativeUnit(statement);

		// index metadata for the statement
		INDEX_WRITER.indexStatementMetadata(statement, urlsByTopicUnit,
				urlsByAlternativeUnit);
		////////////////////////////////////////////////////////////////////////

		Map<String, List<String>> allUnits = new HashMap<String, List<String>>(
				urlsByTopicUnit);
		...
		for (Entry<String, List<String>> urlByUnit : allUnits.entrySet())
		{
			...
			for (String url : urlByUnit.getValue())
			{
